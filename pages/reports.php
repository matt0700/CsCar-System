...
<body class="bg-white">
    <div class="w3-main">
        ...
        <div class="w3-container ml-56">
            ...
            echo "<th class='w-1/6 px-4 py-2 '><a href='?sortBy=make_series_type&sortOrder=" . ($sortOrder == 'asc' ? 'desc' : 'asc') . "' style='color: white; text-decoration: none;'>Vehicle Name</a></th>";
