...
$trips_sql = 'SELECT * FROM trips WHERE ruv_table NOT IN (SELECT ruvNO FROM trips)';
...
if($trips_result->num_rows > 0){
    while ($trip = $trips_result->fetch_assoc()){
        ...
        //Gind available vehicle that can accomodate number of passengers
